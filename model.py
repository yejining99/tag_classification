...
class ContrastiveModel(nn.Module):
    def __init__(self, LLM, tokenizer, use_lora=True, max_length=512, K=None, lora_layer=None, finetuning=False, freeze_layers=3):
        ...
        self.K = K
        self.lora_layer = lora_layer if lora_layer is not None else -1  
